...
with open("./n030w8/Sc-n030w8.txt") as archivo:
...
with open("./n030w8/H0-n030w8-" + historia + ".txt") as archivo:
    for linea in archivo:
...
with open("./n030w8/WD-n030w8-" + semana + ".txt") as archivo:
    for linea in archivo:
...
# Se hace un Algrotimo para reemplazar los turnos que No comple las restriccion 
